...
enum PermisosEnum: string
{
    ...
    case CATEGORIAS_REPORTES_VER = 'CATEGORIAS_REPORTES_VER';
    case CATEGORIAS_REPORTES_CREAR = 'CATEGORIAS_REPORTES_CREAR';
    case CATEGORIAS_REPORTES_EDITAR = 'CATEGORIAS_REPORTES_EDITAR';
    case ESTADISTICAS_VER = 'ESTADISTICAS_VER';
