    ...
    <div class="pb-6 pt-12">
        <div class="mx-auto max-w-[85%] sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                <a
                class="mb-4 flex h-[250px] w-full flex-col items-start justify-center rounded-lg bg-white p-6"
            >
                <p class="text-2xl font-bold text-escarlata-ues">Listado de</p>
                <p class="text-4xl font-black text-escarlata-ues">EVENTOS Y</p>
                    <p class="text-4xl font-black text-escarlata-ues">
                        EVALUACIONES DE LA FACULTAD</p>
                <p class="font-normal my-4 text-gray-500">
                    Mantente pendiente de los ultimos reportes notificados de tu facultad
                </p>
                <div>
                    <form action="{{ route('reportes-generales') }}" method="GET">
                    <x-primary-button><x-heroicon-s-fire class="h-4 mx-2" />{{ __('   Ver listado de reportes') }}</x-primary-button>
                </form>
                </div>
            </a>
            </div>
            ...
            <div class="mx-auto max-w-[85%] sm:px-6 lg:px-8">
                <div class="bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                    <div class="px-16 py-8">
                        <div class="sm:rounded-lg overflow-auto">
                            {{-- FILTROS --}}
