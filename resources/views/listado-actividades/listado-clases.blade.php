    ...
    <div class="pb-6 pt-12">
        <div class="mx-auto max-w-[85%] sm:px-6 lg:px-8">
            ...
            >
                ...
                <p class="text-4xl font-black text-escarlata-ues">CLASES DE LA FACULTAD</p>
                ...
                <div>
                    ...
                    <x-primary-button href="{{ route('reportes-generales') }}"><x-heroicon-s-fire class="h-4 mx-2" />{{ __('   Ver listado de reportes') }}</x-primary-button>
                </form>
                </div>
            </a>
            </div>
