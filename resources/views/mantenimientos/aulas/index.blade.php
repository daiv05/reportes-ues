<x-app-layout>
    <x-slot name="header">
        <x-header-page.head tituloMenor="Gestión de" tituloMayor="AULAS E INSTALACIONES"
            subtitulo="Gestiona todas las instalaciones de la facultad, crea, edita  o cambia de estado.">
        </x-header-page.head>
    </x-slot>
    ...
    <div class="flex flex-col justify-center items-center overflow-x-auto shadow-md sm:rounded-lg min-w-full mx-auto">
