            ...
            <div class="my-8">
                <form id="reporteForm" class="md:mx-16" method="POST" action="{{ route('reportes.store') }}">
                    ...
                    @if (isset($clase) || isset($evento))
                        @if (isset($clase))
                            <input type="hidden" id="id_actividad" name="id_actividad" value="{{ $clase->id_actividad }}"/>
                        @else
                            <input type="hidden" id="id_actividad" name="id_actividad" value="{{ $evento->id_actividad }}"/>
                        @endif
                        <div class="mb-5">
                            <label for="titulo" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">
