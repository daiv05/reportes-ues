                                ...
                                @if (isset($clase))
                                    ...
                                    <tbody>
                                        <x-table.tr>
                                            ...
                                            <x-table.td>
                                                {{ $clase->actividad->asignaturas[0]->escuela->nombre }}
                                            </x-table.td>
                                            <x-table.td>
                                                {{
                                                    Carbon\Carbon::parse($clase->actividad->hora_inicio)->format('h:i A') .
                                                        ' - ' .
                                                        Carbon\Carbon::parse($clase->actividad->hora_fin)->format('h:i A')
                                                }}
                                            </x-table.td>
                                        </x-table.tr>
                                    </tbody>
                                @else
                                    ...
                                    <tbody>
                                        <x-table.tr>
                                            ...
                                            <x-table.td>
                                                {{ Carbon\Carbon::parse($evento->actividad->fecha)->format('d/m/Y') }}
                                            </x-table.td>
                                            <x-table.td>
                                                {{
                                                    Carbon\Carbon::parse($evento->actividad->hora_inicio)->format('h:i A') .
                                                        ' - ' .
                                                        Carbon\Carbon::parse($evento->actividad->hora_fin)->format('h:i A')
                                                }}
                                            </x-table.td>
                                        </x-table.tr>
                                    </tbody>
