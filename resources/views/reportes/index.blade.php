<x-app-layout>
    <x-slot name="header">
        <div class="mb-2 flex h-auto w-full flex-col items-start justify-center rounded-lg bg-white p-6">
            ...
            <p class="text-2xl md:text-3xl font-black text-escarlata-ues">INCIDENCIAS EN LA FACULTAD</p>
            ...
            <div class="flex flex-col justify-center md:justify-start pt-4">
                <a href="{{ route('crear-reporte') }}">
                    <x-forms.primary-button><x-heroicon-s-fire
                            class="h-4 mx-2" />{{ __('   Reportar') }}</x-forms.primary-button>
                </a>
            </div>
        </div>
    </x-slot>
    <div>
        ...
        {{-- TABLA --}}
        <table class="w-full overflow-auto text-left text-sm text-gray-500 dark:text-gray-400 rtl:text-right">
