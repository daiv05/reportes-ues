    ...
    <div class="mb-8 mt-12">
        <div class="flex w-full flex-col lg:flex-row">
            ...
            <div class="w-full px-8 lg:w-[60%]">
                <div class="mb-4">
                    <!-- Fila 1 -->
                    <div class="mb-8 ml-12 text-3xl font-bold">
                        <p>{{ $reporte->titulo }}</p>
                    </div>
                </div>
                <div class="mb-4">
            ...
            <div class="w-full lg:w-[30%]">
                <div class="grid grid-cols-1 grid-rows-8 p-4 lg:grid-cols-2 lg:grid-rows-4">
                    <div><p class="font-semibold text-gray-500">Estado</p></div>
                    <div>
                        <x-status.chips
                    ...
                    <div><p class="font-semibold text-gray-500">Fecha</p></div>
                    <div>
                        <p class="font-semibold text-black">
                            {{ \Carbon\Carbon::parse($reporte->fecha_reporte)->format('d/m/Y') }}
                        </p>
                    </div>
                    <div><p class="font-semibold text-gray-500">Hora</p></div>
                    <div>
                        <p class="font-semibold text-black">
        ...
        @if (! $reporte->estado_ultimo_historial?->nombre && $reporte->no_procede == 0)
            <div class="mt-4 flex w-full flex-col lg:flex-row">
                <!-- Columna izquierda (70%) -->
                <div class="w-full px-8 lg:w-[60%]">
                    <div class="mb-4">
                        <!-- Fila 1 -->
                        <div class="mb-8 ml-12 text-xl font-bold">
                            <p>Asignación</p>
                        </div>
                    </div>
                    <div class="mb-4">
                            ...
                            <div class="ml-12 mt-2">
                                ...
                                >
                                    @foreach ($entidades as $entidad)
                                        <option
                                            value="{{ $entidad->id }}"
                                            {{ $reporte->id_entidad == $entidad->id ? 'selected' : '' }}
                                        >
                                            {{ $entidad->nombre }}
                                        </option>
                                    @endforeach
                    ...
                    <div class="mb-4">
                        ...
                        <div class="font-semibold">
                            <div class="flex flex-row gap-6">
                                ...
                                <button id="fetchData" class="rounded border border-black bg-white px-5 text-black">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                                        viewBox="-2 -2 30 30"
                            ...
                            <div class="ml-12 mt-2">
                                    ...
                                    function renderSelectedEmployeesTable() {
                                        ...
                                        selectedEmployees.forEach((empleado, index) => {
                                            ...
                                            removeButton.addEventListener('click', () => {
                                                ...
                                                id_empleados_puestos.splice(
                                                    id_empleados_puestos.indexOf(empleado.id_empleado_puesto),
                                                    1,
                                                );
                                                renderSelectedEmployeesTable();
                                            });
                                ...
                                <div id="noResultsLabel" style="display: none" class="mt-4 font-bold text-red-500">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="font-semibold">
                            <div class="flex flex-row gap-6">
                                ...
                                <button
                                    id="fetchSupervisors"
                                    class="ml-0.5 rounded border border-black bg-white px-5 text-black"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                            ...
                            <div class="ml-12 mt-2">
                                <script>
                                    ...
                                    document
                                        .getElementById('fetchSupervisors')
                                        .addEventListener('click', fetchSupervisors);
                                    ...
                                    function fetchSupervisors() {
                                        ...
                                        fetch(url)
                                            .then((response) => response.json())
                                            .then((data) => {
                                                const supervisorTableContainer =
                                                    document.getElementById('supervisorTableContainer');
                                                const noSupervisorResultsLabel =
                                                    document.getElementById('noSupervisorResultsLabel');
                                    ...
                                    function renderSelectedSupervisorsTable() {
                                        const selectedSupervisorTableContainer = document.getElementById(
                                            'selectedSupervisorTableContainer',
                                        );
                    ...
                    <div class="mb-4">
                        ...
                        <div class="font-semibold">
                            ...
                            <div class="ml-12 mt-2">
                                <x-text-area id="comentario" rows="8" :disabled="false"></x-text-area>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="w-full lg:w-[25%]">
                    ...
                    <x-modal name="confirm-modal" :show="false" maxWidth="md">
                        <div class="p-6">
                            <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">Confirmación</h2>
                            <p class="mt-4 text-sm text-gray-600 dark:text-gray-400">
                                ¿Estás seguro de que deseas marcar este reporte como "No procede"?
                            </p>
                        </div>
                        <div class="flex justify-end bg-gray-100 px-6 py-4 text-right dark:bg-gray-800">
                            <button
                            ...
                            <button id="confirmMarcarNoProcede" class="ml-2 rounded bg-red-700 px-4 py-2 text-white">
                                Confirmar
                            </button>
                        </div>
                    </x-modal>
                    ...
                    <script>
                        document.getElementById('confirmMarcarNoProcede').addEventListener('click', function () {
                            ...
                            axios
                                .put(
                                    `/reportes/marcar-no-procede/${idReporte}`,
                                    {},
                                    {
                                        headers: {
...
<script>
    ...
    console.log(@json($accionesReporte));
</script>
