...
<x-app-layout>
    ...
    <div>
        {{-- FILTROS --}}
        <div class="flex flex-col space-y-4 pb-4 justify-center sm:justify-start sm:flex-row sm:space-y-0 sm:space-x-4">
            <form method="GET" action="{{ route('reportes-generales') }}"
                ...
                <div class="flex space-x-2">
                    <button type="submit"
                        class="align-middle justify-center inline-flex rounded-full items-center w-10 h-10 border border-transparent shadow-sm text-sm font-medium text-white bg-escarlata-ues hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                    ...
                    <button type="reset"
                        class="align-middle justify-center inline-flex rounded-full items-center px-3 py-3 shadow-sm text-sm font-medium bg-white border border-gray-500 text-gray-500 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
