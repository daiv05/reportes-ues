<x-app-layout>
    ...
    <div class="flex items-center justify-between p-6">
        <form method="GET" action="{{ route('puestos.index') }}" class="flex flex-wrap items-center space-x-4">
            <div class="flex items-center space-x-2">
                ...
                <select id="id_departamento" name="id_departamento"
                        class="mt-1 block rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:border-red-500 focus:outline-none focus:ring-red-500 dark:bg-gray-700 dark:text-gray-300 sm:text-sm">
            ...
            <button type="submit"
                    class="rounded-md bg-escarlata-ues hover:bg-red-600 px-4 py-2 text-sm font-medium text-white focus:outline-none focus:ring-4">
                Filtrar
            </button>
        </form>

        <!-- Botón Añadir -->
        <button id="add-button" class="rounded-md bg-red-700 hover:bg-red-600 px-6 py-2 text-sm font-medium text-white focus:outline-none focus:ring-4">
            Añadir Puesto
        </button>
    </div>

    <!-- Tabla de puestos -->
    <div class="mx-auto min-w-full p-6 overflow-x-auto bg-white shadow-md sm:rounded-lg">
        <table class="w-full text-left text-sm text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="4" class="px-6 py-4 text-center text-gray-500 dark:text-gray-400">No se encontraron puestos</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
    ...
    <!-- Modal para Añadir/Editar Puesto -->
