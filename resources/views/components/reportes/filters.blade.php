...
<div>
    <form method="GET" action="{{ route($ruta) }}"
        class="flex-column flex flex-wrap items-center justify-center md:justify-start gap-4 sm:flex-row">
        <div>
        ...
        <div>
            <select id="tipoReporte" name="tipoReporte"
                class="sm:w-50 block min-w-40 w-full rounded-lg border border-gray-300 bg-white p-2 px-3 py-2 text-sm font-medium text-gray-500 focus:border-red-500 focus:ring-red-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-red-500 dark:focus:ring-red-500">
        ...
        <div>
            <select id="estado" name="estado"
                class="sm:w-50 block min-w-32 w-full rounded-lg border border-gray-300 bg-white p-2 px-3 py-2 text-sm font-medium text-gray-500 focus:border-red-500 focus:ring-red-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-red-500 dark:focus:ring-red-500">
        ...
        <div class="relative py-1">
            <div class="rtl:inset-r-0 pointer-events-none absolute inset-y-0 left-0 flex items-center align-middle ps-3 rtl:right-0">
                <svg class="h-4 w-4 text-gray-500 dark:text-gray-400" aria-hidden="true" fill="currentColor"
            ...
            <input type="text" id="table-search" name="titulo" value="{{ request('titulo') }}"
                maxlength="50"
                class="block w-full rounded-lg border border-gray-300 bg-white px-3 py-2 ps-10 text-sm font-medium text-gray-500 focus:border-red-500 focus:ring-red-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-red-500 dark:focus:ring-red-500 sm:w-80"
        ...
        <div class="relative flex space-x-2 justify-center pt-1">
            ...
            <button type="reset" data-tooltip-target="tooltip-limpiar-filtros"
