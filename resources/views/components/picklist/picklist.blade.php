...
<div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 py-4">
    ...
    @php
        $controlsClass =
            'bg-red text-black p-1 rounded-full shadow hover:bg-red-600 hover:text-white flex items-center justify-center rotate-90 sm:rotate-0';
    @endphp
    ...
    @if (!$disabled)
        ...
        <div class="flex flex-row sm:flex-col justify-center space-x-2 sm:space-x-0 sm:space-y-2">
            <button type="button" class="add-all-items {{ $controlsClass }}">
                <x-heroicon-o-chevron-double-right class="h-7 w-7" />
            </button>
            ...
            <button type="button" class="remove-all-items {{ $controlsClass }}">
                <x-heroicon-o-chevron-double-left class="h-7 w-7" />
            </button>
        </div>
    @endif
