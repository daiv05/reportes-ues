<x-app-layout>
    ...
    <div class="container mx-auto mt-12 px-4">
        <div class="text-center mb-12">
            <h2 class="text-4xl font-bold mb-4 text-orange-900">No se ha encontrado el recurso</h2>
            <p class="text-xl text-gray-600">Lo sentimos, pero el recurso que buscas no se existe o no se encuentra disponible</p>
        </div>
