                        ...
                        <div class="overflow-auto">
                            <div class="container mx-auto mt-12 px-4">
                                <div class="text-center mb-12">
                                    <h2 class="text-4xl font-bold mb-4 text-orange-900">Ha ocurrido un error inesperado
                                    </h2>
                                    <p class="text-xl text-gray-600 mb-16">Por favor vuelve a intentarlo mas tarde</p>
                                    </p>
                                    <a href="/"
