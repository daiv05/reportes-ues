...
Route::middleware('auth', 'validate_user', 'verified', 'two_factor')->group(function () {
    ...
    Route::prefix('reportes')->group(function () {
        ...
        Route::post('/marcar-no-procede/{id}', [ReporteController::class, 'marcarNoProcede'])->middleware('permission:REPORTES_ASIGNAR')->name('reportes.noProcede');
    ...
    Route::prefix('mantenimientos')->group(function () {
        ...
        Route::patch('asignatura/{asignatura}', [AsignaturaController::class, 'update'])->middleware('permission:ASIGNATURAS_EDITAR')->name('asignatura.patch');
